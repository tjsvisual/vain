        ...
        <div class="row headerAdu">
            ...
            <div class="col-lg-5 homeSearch">
                <div class="homeSearchWrapper">
                    ...
                    <span></span>
                    <input id="searchform-item" value="" name="SearchForm[item]" type="search"  placeholder="Search in Nigeria">
    ...
    <div class="footer-bottom text-center">
        <div class="container">
            ...
            <div class="copyrights">
                ...
                <p> © <?= date("Y",time()) ?> <?= $siteSetting->site_name; ?>.<?=  Yii::t('app', 'All Rights Reserved | Design by ') ?> <a href="http://BNS.com/">BNS</a></a></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
